...
const VideoForm = ({ formData, setFormData }: VideoFormProps) => {
  ...
  const unboxingVideoId = extractVideoId(formData.unboxing_yt_video_url || "");
    ...
    <div className="space-y-4">
      ...
      <div className="border border-gray-300 rounded-lg p-4 bg-white">
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">
            Enter a YouTube video URL to showcase your product unboxing
          </p>
        </div>
        ...
        {unboxingVideoId && (
          <div className="mt-4">
            ...
            <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden">
              <iframe
                src={`https://www.youtube.com/embed/${unboxingVideoId}`}
                title="YouTube video preview"
                className="w-full h-full"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        ...
        {formData.unboxing_yt_video_url && !unboxingVideoId && (
          <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-sm text-yellow-800">
              Please enter a valid YouTube URL. Supported formats:
            </p>
