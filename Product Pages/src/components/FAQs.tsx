...
export default function FAQs() {
  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: "You can easily order your favorite product by browsing our online catalog, selecting the item, choosing your preferred color and specifications, and then clicking the 'Add to Cart' button. Follow the checkout process to complete your order."
    },
    {
      id: 2,
      question: "How can I complete the order with payment ?",
      answer: "To complete your order, proceed to checkout where you'll be prompted to provide shipping information and payment details. We accept credit/debit cards, PayPal, and Apple Pay. Once payment is confirmed, you'll receive an order confirmation email."
    },
    {
      id: 3,
      question: "Which payments options are available ?",
      answer: "We offer multiple payment options including all major credit and debit cards (Visa, Mastercard, American Express), PayPal, Apple Pay, Google Pay, and bank transfers for select countries. All transactions are secured with industry-standard encryption."
    },
    {
      id: 4,
      question: "How can I get refund for return products ?",
      answer: "To receive a refund for returned products, first initiate a return request through your account within 30 days of purchase. Once we receive and inspect the returned item, we'll process your refund to the original payment method within 5-7 business days."
    },
    {
      id: 5,
      question: "How can I be confident of the quality ?",
      answer: "We stand behind the quality of our products with a comprehensive 12-month warranty. All our items undergo rigorous quality testing before shipping, and we source components only from certified suppliers. Our customer satisfaction rate exceeds 98%."
    }
  ];
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        ...
        if (entry.isIntersecting) {
          ...
          // Reset animation state when component leaves view
          setIsVisible(false);
        }
      },
      { threshold: 0.2 }
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 py-20 px-4 overflow-hidden relative" ref={sectionRef} id='faq'>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-16 max-w-3xl mx-auto">
          Find answers to commonly asked questions about our products, ordering process, 
          payment options, and more to help you make informed decisions.
        </p>
          ...
          >
            {faqItems.map((item) => (
              <motion.div 
                ...
                style={{ 
                  borderLeft: openItem === item.id ? '4px solid #8b5cf6' : '4px solid transparent'
                }}
              >
                <button
                ...
                >
                  <h3 className="font-medium text-gray-800 text-lg">{item.question}</h3>
                  <motion.div 
